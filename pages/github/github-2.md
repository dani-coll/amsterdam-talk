...
<h2>Structure</h2>
<ul>
	<li>Feedback of 2000 users using Github Copilot</li>
	<li>Demo of the Happy Path</li>
	<br>
	<v-click> 
		<h2>Key takeaways</h2>
		<li>Drawbacks</li>
		<img class="drawbacks" src="assets/github-drawbacks.png" height="100" width="300" style="margin-left:50px"></img>
