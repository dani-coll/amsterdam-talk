...
<img src="assets/qwik-serverside.png"/>

<v-click>
	<h2>Problem</h2>
	<li>Appears faster, but is slower</li>
	<v-click>
		<li style="margin-left: 50px">Duplicate information</li>
	</v-click>
</v-click>
...
<!-- Hello world, twice  and javascript reexecuting -->